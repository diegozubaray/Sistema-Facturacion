insert into clientes (nombre,apellido,email,create_at) values ('Diego','Zubaray','diego@gmail.com','1987-03-07');
insert into clientes (nombre,apellido,email,create_at) values ('Agus','Zubaray','agus@gmail.com','2005-07-18');
insert into clientes (nombre,apellido,email,create_at) values ('Benja','Zubaray','benja@gmail.com','2009-09-07');
INSERT INTO clientes (nombre, apellido, email, create_at) VALUES('Carlos', 'Gomez', 'carlos@gomez.com', '2017-08-01');
